...
// REMOVE: import { StoreLayout } from "@/components/layout/StoreLayout"; // This line should be removed
...
const Storefront = () => {
  ...
  if (loading) {
    return (
      // When loading, only return the content that will be placed inside the layout
  ...
  if (!store) {
    return (
      // When store not found, only return the content that will be placed inside the layout
      <div className="container mx-auto px-4 py-12">
        <div className="flex justify-center items-center min-h-[60vh]">
  ...
  return (
    // REMOVE THE StoreLayout WRAPPER HERE
