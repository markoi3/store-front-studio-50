...
import { FooterSettings, FooterColumn, FooterLink, SocialMediaLink } from "@/types/footer";
...
const FooterEditor = () => {
  ...
  useEffect(() => {
    if (user?.store?.settings?.footer) {
      setFooterSettings(user.store.settings.footer);
    }
  }, [user]);
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      checked={footerSettings.newsletter.enabled}
                      onCheckedChange={(checked) => 
                        setFooterSettings(prev => ({
                          ...prev,
              ...
              {footerSettings.newsletter.enabled && (
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      id="newsletter-title"
                      value={footerSettings.newsletter.title}
                      onChange={(e) => 
                        setFooterSettings(prev => ({
                          ...prev,
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={footerSettings.newsletter.placeholder}
                      onChange={(e) => 
                        setFooterSettings(prev => ({
                          ...prev,
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={footerSettings.newsletter.buttonText}
                      onChange={(e) => 
                        setFooterSettings(prev => ({
                          ...prev,
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={footerSettings.newsletter.successMessage}
                      onChange={(e) => 
                        setFooterSettings(prev => ({
                          ...prev,
